...
import { fedApi, type FedConfigRow } from '@/lib/fedApi'
import { cn } from '@/lib/utils'
import cloudFedIcon from '@/assets/cloud-fed.png'

const CLOUD_URL = (import.meta.env.VITE_FED_CLOUD_URL as string | undefined)?.trim()

export function FedToolbar() {
  const [open, setOpen] = useState(false)
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  const [rows, setRows] = useState<FedConfigRow[]>([])
